...
-- Table for capturing error logs
...
-- Insert sample records into Accounts
...
-- Insert sample records into Transactions
...
BEGIN
    ...
    -- Insert new account with the generated ACCOUNTID
    INSERT INTO Accounts (AccountID, CustomerID, AccountType, Balance, LastModified) 
