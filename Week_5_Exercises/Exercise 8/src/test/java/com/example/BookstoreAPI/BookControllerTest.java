...
public class BookControllerTest {
    ...
    public void testUpdateBook() throws Exception {
        // Mock existing book and the updated book
    ...
    public void testDeleteBook() throws Exception {
        // Mock a book to be deleted
        Book book = new Book("1234567890123", "The Alchemist", "Paulo Coelho", 300);

        // Mock the repository to find the book by ISBN
        Mockito.when(bookRepository.findById(Long.valueOf("1234567890123"))).thenReturn(Optional.of(book));

        // Mock the repository to do nothing when deleting a book
